document.addEventListener('livewire:navigated', () => {
    ...
    ! function (n) {
        ...
        var t, a = document.body.getAttribute("data-topbar");

        function s(e) {
            1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (n("#dark-mode-switch").prop("checked", !1), document.body.setAttribute("data-bs-theme", "light"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == n("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (1 == n("#rtl-mode-switch").prop("checked") ? n("html").attr("dir", "rtl") : n("html").removeAttr("dir"), n("#light-mode-switch").prop("checked", !1), "dark" == a && document.body.setAttribute("data-sidebar", "light"), document.body.setAttribute("data-bs-theme", "dark"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == n("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e ? (n("html").attr("dir", "rtl"), n("#light-mode-switch").prop("checked", !1), n("#dark-mode-switch").prop("checked", !1), n("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css"), n("#app-style").attr("href", "assets/css/app-rtl.min.css"), n("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 0 == n("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (n("html").removeAttr("dir"), n("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"), n("#app-style").attr("href", "assets/css/app.min.css"))
        }
        ...
        if (n("#side-menu").metisMenu(), n("#vertical-menu-btn").on("click", function (e) {
            ...
            for (var o = document.getElementById("topnav-menu-content").getElementsByTagName("a"), c = 0, l = o.length; c < l; c++) o[c].onclick = function (e) {
        ...
        }), window.sessionStorage && ((t = sessionStorage.getItem("is_visited")) ? (n(".right-bar input:checkbox").prop("checked", !1), n("#" + t).prop("checked", !0), s(t)) : sessionStorage.setItem("is_visited", "light-mode-switch")), n("#light-mode-switch, #dark-mode-switch, #rtl-mode-switch").on("change", function (e) {
            s(e.target.id)
        }), Waves.init()
    }(jQuery);
